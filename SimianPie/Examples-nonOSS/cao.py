# NOTE: This example has been marked as for internal consumption only. Not for open source release.
#
##############################################################################
# Author: Unknown
# Date: Unknown
...
#simName, startTime, endTime, minDelay, useMPI, mpiLib = "Simulation", 0, 999999999999999999999, 0.0001, True, "/opt/local/lib/mpich-mp/libmpich.dylib"
simName, startTime, endTime, minDelay, useMPI, mpiLib = "Simulation", 0, 999999999999999999999, 0.0001, False, "/opt/local/lib/mpich-mp/libmpich.dylib"
simEngine = Simian(simName, startTime, endTime, minDelay, useMPI, mpiLib)
